...
eval { $v .= pmver('Email::MIME::Kit','any version') };
eval { $v .= pmver('Email::MIME::Kit::ManifestReader::JSON','any version') };
eval { $v .= pmver('Email::MIME::Kit::Renderer::TT','any version') };
eval { $v .= pmver('Email::Sender::Simple','any version') };
eval { $v .= pmver('Email::Sender::Transport::Maildir','any version') };
...
eval { $v .= pmver('MCE::Map','any version') };
